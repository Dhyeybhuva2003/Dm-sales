...
export const DateWiseItemWise = () => {
    ...
    const CustomToolbar = () => (
        <GridToolbarContainer>
            <GridToolbar />
            <h5 style={{ paddingTop: "10px", fontSize: "16px" }}>
                Date Wise Item Summary: {itemdate} | Total selling Price: {Math.round(total)}
            </h5>
        </GridToolbarContainer>
    );
                            ...
                            <form onSubmit={handleSubmit(submitData)} id="forms">
                                <div className="row">
                                    ...
                                    <div className="col-md-6 pt-2">
                                        <button type="submit" className="btn btn-primary me-1 mt-4">Submit</button>
                                        <button
                                            type="button"
                                            className="btn btn-primary me-3 mt-4"
                                            onClick={() => document.getElementById("forms").reset()}
                                        >
                                            Reset
                                        </button>
                                    </div>
